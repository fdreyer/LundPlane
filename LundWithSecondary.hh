...
public:
  ...
  virtual std::vector<LundDeclustering> primary(const PseudoJet& jet) const;
  
  /// secondary Lund declustering (slow)
  virtual std::vector<LundDeclustering> secondary(const PseudoJet& jet) const;
  
  /// secondary Lund declustering with primary sequence as input
  virtual std::vector<LundDeclustering> secondary(const PseudoJet& jet,
